...
=head1 ERDBtk Ternary Value Type Definition
...
=head3 new
    ...
    my $et = ERDBtk::Type::SemiBoolean->new();

Construct a new ERDBtk::Type::SemiBoolean descriptor.
...
sub new {
    # Get the parameters.
    my ($class) = @_;
    # Create the ERDBtk::Type::SemiBoolean object.
    my $retVal = { };
    # Bless and return it.
    bless $retVal, $class;
    return $retVal;
...
=head3 ComputeFromString
    ...
    my $char = ERDBtk::Type::SemiBoolean::ComputeFromString($string);
