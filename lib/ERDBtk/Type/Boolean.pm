...
=head1 ERDBtk Boolean Type Definition
...
=head3 new
    ...
    my $et = ERDBtk::Type::Boolean->new();

Construct a new ERDBtk::Type::Boolean descriptor.
...
sub new {
    # Get the parameters.
    my ($class) = @_;
    # Create the ERDBtk::Type::Boolean object.
    my $retVal = { };
    # Bless and return it.
    bless $retVal, $class;
    return $retVal;
