...
=head1 ERDBtk DNA Type Definition
...
=head3 new
    ...
    my $et = ERDBtk::Type::DNA->new();

Construct a new ERDBtk::Type::DNA descriptor.
...
sub new {
    # Get the parameters.
    my ($class) = @_;
    # Create the ERDBtk::Type::DNA object.
    my $retVal = { };
    # Bless and return it.
    bless $retVal, $class;
    return $retVal;
