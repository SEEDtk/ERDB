...
package ERDBtk::Type::ShortString;
...
=head1 ERDBtk Short String Type Definition
...
=head3 new
    ...
    my $et = ERDBtk::Type::ShortString->new();

Construct a new ERDBtk::Type::ShortString descriptor.
...
sub new {
    # Get the parameters.
    my ($class) = @_;
    # Create the ERDBtk::Type::ShortString object.
    my $retVal = { };
    # Bless and return it.
    bless $retVal, $class;
    return $retVal;
