...
=head1 ERDBtk Hash String Type Definition
...
=head3 new
    ...
    my $et = ERDBtk::Type::HashString->new();

Construct a new ERDBtk::Type::HashString descriptor.
...
sub new {
    # Get the parameters.
    my ($class) = @_;
    # Create the ERDBtk::Type::HashString object.
    my $retVal = { };
    # Bless and return it.
    bless $retVal, $class;
    return $retVal;
