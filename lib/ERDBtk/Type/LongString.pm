...
=head1 ERDBtk Long String Type Definition

=head2 Introduction

This type represents fully-indexable strings up to 500 characters long. Most
strings in an ERDBtk system have an indexable length limit of 250, because this
...
=head3 new
    ...
    my $et = ERDBtk::Type::LongString->new();

Construct a new ERDBtk::Type::LongString descriptor.
...
sub new {
    # Get the parameters.
    my ($class) = @_;
    # Create the ERDBtk::Type::LongString object.
    my $retVal = { };
    # Bless and return it.
    bless $retVal, $class;
    return $retVal;
