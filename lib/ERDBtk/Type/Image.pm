...
=head1 ERDBtk Image Type Definition
...
=head3 new
    ...
    my $et = ERDBtk::Type::Image->new();

Construct a new ERDBtk::Type::Image descriptor.
...
sub new {
    # Get the parameters.
    my ($class) = @_;
    # Create the ERDBtk::Type::Image object.
    my $retVal = { };
    # Bless and return it.
    bless $retVal, $class;
    return $retVal;
...
=head3 NewSessionID
    ...
    my $id = ERDBtk::Type::Image::NewSessionID();
...
sub html {
    ...
    my $oh = Open(undef, ">$ERDBtkExtras::temp/$fileName");
    print $oh $value->png();
    close $oh;
    my $retVal = CGI::img({ src => "$ERDBtkExtras::temp_url/$fileName" });
    return $retVal;
}
