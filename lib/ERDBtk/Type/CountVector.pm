...
=head1 ERDBtk CountVector Descriptor Type Definition
...
=head3 new
    ...
    my $et = ERDBtk::Type::CountVector->new();

Construct a new ERDBtk::Type::CountVector descriptor.
...
sub new {
    # Get the parameters.
    my ($class) = @_;
    # Create the ERDBtk::Type::CountVector object.
    my $retVal = { };
    # Bless and return it.
    bless $retVal, $class;
    return $retVal;
...
=head3 NumToString
    ...
    my $string = ERDBtk::Type::CountVector::NumToString($number);
...
=head3 StringToNum
    ...
    my $number = ERDBtk::Type::CountVector::StringToNum($string);
...
=head3 VectorLength
    ...
    my $length = ERDBtk::Type::CountVector::VectorLength($vector);
...
=head3 DotProduct
    ...
    my $product = ERDBtk::Type::CountVector::DotProduct($vector1, $vector2);
