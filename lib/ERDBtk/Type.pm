...
=head1 ERDBtk Database Type Definition Base Class

=head2 Introduction

This class describes an ERDBtk type. All ERDBtk types are defined as subclasses of
...
objects unrelated to the ERDBtk type classes.

=cut

=head3 new

    my $et = ERDBtk::Type->new();

Construct a new ERDBtk::Type object. The following options are supported.
...
value is specified in the database definition or in an L<ERDBtkLoadGroup/Put>
