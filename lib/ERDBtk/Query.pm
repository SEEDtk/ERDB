...
At each point in the result set, the iterator returns a L<ERDBtk::Object>. The ERDBtk::Object allows the
...
Retrieve a record from this query. The record returned will be a L<ERDBtk::Object>, which
