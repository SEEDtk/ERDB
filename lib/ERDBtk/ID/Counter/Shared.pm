...
package ERDBtk::ID::Counter::Shared;
...
=head3 new
    ...
    my $helper = ERDBtk::ID::Counter::Shared->new($entityName, $loader, $stats, %options);
...
sub InsertNew {
    ...
    $fields{id} = $retVal;
    # Get the ERDBtk object, the entity name, and the statistics object.
    my $erdb = $self->db;
