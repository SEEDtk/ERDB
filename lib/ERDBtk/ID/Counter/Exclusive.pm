...
package ERDBtk::ID::Counter::Exclusive;
...
=head1 ERDBtk Auto-Counter ID Helper for Exclusive Database Access

This is a subclass for L<ERDBtk::ID> that manages auto-counter IDs for environments when the
...
=head3 new
    ...
    my $helper = ERDBtk::ID::Counter::Exclusive->new($entityName, $loader, $stats, %options);
