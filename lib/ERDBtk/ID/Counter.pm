...
package ERDBtk::ID::Counter;

    use strict;
    use warnings;
    use base qw(ERDBtk::ID);

=head1 ERDBtk AutoCounter Helper

This is the ID helper class for auto-counter IDs. It is a subclass of L<ERDBtk::ID>, and is used
...
=head3 new
    ...
    my $helper = ERDBtk::ID::Counter->new($entityName, $loader, $stats, %options);
...
sub new {
    ...
    if ($options{exclusive}) {
        require ERDBtk::ID::Counter::Exclusive;
        $retVal = ERDBtk::ID::Counter::Exclusive->new($entityName, $loader, $stats, %options);
    } else {
        require ERDBtk::ID::Counter::Shared;
        $retVal = ERDBtk::ID::Counter::Shared->new($entityName, $loader, $stats, %options);
    }
