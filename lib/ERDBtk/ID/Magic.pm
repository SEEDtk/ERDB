...
=head1 ERDBtk Magic Name Helper

This is the ID helper class for magic name IDs. It is a subclass of L<ERDBtk::ID>, and is used
...
sub new {
    ...
    if ($options{exclusive}) {
        require ERDBtk::ID::Magic::Exclusive;
        $retVal = ERDBtk::ID::Magic::Exclusive->new($entityName, $loader, $stats, %options);
    } else {
        require ERDBtk::ID::Magic::Shared;
        $retVal = ERDBtk::ID::Magic::Shared->new($entityName, $loader, $stats, %options);
    }
