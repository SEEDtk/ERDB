...
Return the L<ERDBtk> object that connects to the database.
...
L<ERDBtk> object for accessing the database.
...
=head3 new
    ...
    my $helper = ERDBtk::ID->new($entityName, $loader, $stats, %options);
...
Return the L<ERDBtk> object for accessing the database.
...
sub Check {
    Confess("Pure virtual ERDBtk::ID::Check method called.");
}
...
sub InsertNew {
    Confess("Pure virtual ERDBtk::ID::InsertNew method called.");
}
