...
package ERDBtk::Helpers::SQLBuilder;
...
This object is used to manage the creation of SQL statements for ERDBtk. An SQL statement must be
formed from an L<object name list|ERDBtk/Object Name List>, a L<filter clause|ERDBtk/FIlter Clause>,
and a L<list of field names|ERDBtk/Standard Field Name Format>. The lists can be either list
...
The L<ERDBtk> object for which an SQL statement is being built.
...
=head3 new
    ...
    my $sqlHelper = ERDBtk::Helpers::SQLBuilder->new($erdb, $objectNames);
...
The L<ERDBtk> object for the database this SQL statement will access.

=item objectNames

An ERDBtk L<object name list|ERDBtk/Object Name List>, specified as either a list
...
A field name list in L<standard field name format|ERDBtk/Standard Field Name Format>. If undefined,
...
An L<ERDBtk filter clause|ERDBtk/Filter Clause> constraining the current query.
...
Return the relevant L<ERDBtk> object.
...
This method will take a field name in L<standard field name format|ERDBtk/Standard Field Name Format>
...
The name, in L<standard field name format|ERDBtk/Standard Field Name Format>, of the
desired field.
