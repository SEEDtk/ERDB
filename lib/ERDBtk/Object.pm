...
Package (L<ERDBtk>. This object is usually returned by the C<Fetch> method of
the B<ERDBtk::Query> object.
...
Each L<ERDBtk::Object> has at least one object called the I<target object>. This
...
If the ERDBtk::Object was created by a database query, the attributes returned will
...
A standard field specifier. See L<ERDBtk/Standard Field Name Format>. The
...
Name of the field whose value is desired, in the L<ERDBtk/Standard Field Name Format>.
...
Name of the desired attribute, in the L<ERDBtk/Standard Field Name Format>.
...
=head3 _new
    ...
    my $erdbObject = ERDBtk::Object->_new($helper, \@values);

Create an B<ERDBtk::Object> for the current database row.

=over 4

=item helper

L<ERDBtk::Helpers::SQLBuilder> object for the relevant query.
...
Returns an B<ERDBtk::Object> that can be used to access fields from this row of data.
