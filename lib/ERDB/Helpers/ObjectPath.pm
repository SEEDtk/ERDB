...
package ERDB::Helpers::ObjectPath;

    use strict;
    use warnings;
    use base qw(ERDB::Helpers::SQLBuilder);
    ## more use clauses

=head1 ERDB Object Path Helper
...
This object is based on L<ERDB::Helpers::SQLBuilder>. It has the following additional fields.
...
=head3 new
    ...
    my $pathObj = ERDB::Helpers::ObjectPath->new($erdb, $objects);

Create a new ERDB Object Path Helper for a given object path.

=over 4

=item erdb

An L<ERDB> object for the target database.

=item objects

Reference to a list of object names forming an L<object name list|ERDB/Object Name List>.
...
sub new {
    ...
    # Create the object.
    my $retVal = ERDB::Helpers::SQLBuilder::new($class, $erdb, $objects);
...
A L<filter clause|ERDB/Filter Clause> for the deletion
